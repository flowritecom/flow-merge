...
class Model(BaseModel):
    ...
    def from_path(cls, path: str, token: str, directory_settings: DirectorySettings):
        metadata_service = ModelMetadataService(token=token, directory_settings=directory_settings)
        ...
        return cls(
            ...
            trust_remote_code=metadata.hf_transformers_info.trust_remote_code if metadata.hf_transformers_info else False,
        )
