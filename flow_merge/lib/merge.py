...
class MergeExecutor:
    ...
    # low level should be "bias" + tensor weights of all models + method to use
    ...
    def _get_all_model_tensors(
        ...
        models_with_tensors = {
            model: TensorRepository.get_tensor(
                shards=model.shards,
                tensor_key=model_weight.name,
    ...
    def _get_base_model_tensor(
        ...
        return TensorRepository.get_tensor(
